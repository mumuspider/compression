...
def parse_args():
    ...
    #
    parser.add_argument('--model_type', type=str, default='Finer')
    ...
    parser.add_argument("--pool_size", type=int, default=3)  # For SCGINR context pooling
...
def setup_logging(args, img_name):
    ...
    if args.model_type == 'SCGINR':
        exp_name += f"_Tdim{args.table_dim}_pool{args.pool_size}"
